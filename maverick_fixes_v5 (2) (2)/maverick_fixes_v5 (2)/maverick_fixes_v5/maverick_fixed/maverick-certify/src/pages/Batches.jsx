...
import { Card, Badge, Button, PageHeader, ProgressBar, Pagination, usePaginatedData } from '../components/index.jsx';
...
function BatchCard({ batch, onClick }) {
  ...
  return (
    <Card className="p-5 hover:border-teal-500/30 transition-all cursor-pointer" hover onClick={onClick}>
