        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            ...
            <input
              ...
              className="w-full bg-surface-muted border border-surface-border rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-teal-500 mb-4"
            />

            <div className="bg-teal-500/10 border border-teal-500/20 rounded-lg p-3 mb-4">
              <p className="text-xs text-teal-300 font-medium mb-1">✦ Auto-fetch mode active</p>
