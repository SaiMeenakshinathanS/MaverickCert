        ...
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full bg-surface-muted border border-surface-border rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-teal-500"
            />
          </div>
          <button
            onClick={handleSearch}
            disabled={loading || !inputBatchId.trim()}
            className="px-4 py-2.5 bg-teal-600 hover:bg-teal-500 disabled:opacity-40 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
          >
                      ...
                      <tr key={i} className="table-row">
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 bg-teal-600/30 rounded-full flex items-center justify-center text-xs font-semibold text-teal-300 flex-shrink-0">
