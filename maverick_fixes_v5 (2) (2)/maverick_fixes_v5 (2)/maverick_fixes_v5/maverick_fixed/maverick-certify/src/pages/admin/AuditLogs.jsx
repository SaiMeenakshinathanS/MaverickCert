...
import { Card, Badge, PageHeader, Pagination, usePaginatedData } from '../../components/index.jsx';
...
export default function AuditLogs() {
  ...
  // Pagination for the audit log table
  const { page, pageSize, total, pageItems: pagedLogs, setPage, setPageSize } = usePaginatedData(filtered, 10);
                    ...
                    <tr key={log._id} className="table-row">
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-full flex items-center justify-center text-xs font-semibold text-white shadow-sm shadow-violet-500/30">
                      ...
                      <td className="px-5 py-3.5">
                        <Badge variant={TYPE_COLORS[(log.type || '').trim().toLowerCase()] || 'default'}>{log.type}</Badge>
                      </td>
