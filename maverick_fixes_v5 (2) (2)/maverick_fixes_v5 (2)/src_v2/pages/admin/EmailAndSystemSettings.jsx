...
const activityTypeConfig = {
  settings: { icon: '⚙', color: 'text-indigo-400', bg: 'bg-indigo-500/10' },
  user:     { icon: '◉', color: 'text-blue-400',   bg: 'bg-blue-500/10'   },
  reminder: { icon: '◷', color: 'text-amber-400',  bg: 'bg-amber-500/10'  },
};
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="p-5 flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-400 text-lg shrink-0">
                ✉
              </div>
              <div>
            ...
            <Card className="p-5 flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-red-500/10 flex items-center justify-center text-red-400 text-lg shrink-0">
                ✗
              </div>
              <div>
                ...
                {data.recentActivity.map((item, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center gap-4 px-6 py-4 hover:bg-white/[0.02] transition-colors">
                      <div className={`w-8 h-8 rounded-lg ${cfg.bg} flex items-center justify-center ${cfg.color} text-sm shrink-0`}>
                        {cfg.icon}
                      </div>
